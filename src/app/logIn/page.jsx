        ...
        <>
            ...
            <div className="min-h-screen flex flex-col items-center justify-center bg-[#111] relative text-white">
                ...
                <div className="relative z-10 max-w-lg w-full bg-black/80 p-10 rounded-lg shadow-lg border border-[#E2E7EA]">
                    <h2 className="text-4xl font-extrabold text-center mb-6 text-[#72D53C]">Log In</h2>
                    <p className="text-lg text-center text-[#E2E7EA] mb-8">Access your account and start betting smarter.</p>
                    ...
                    <div className="mt-6 text-center text-[#E2E7EA]">
                        <p>Don't have an account? 
                            <a href="/signUp" className="text-[#72D53C] font-semibold ml-1 hover:underline">
                                Sign up
                            </a>
                        </p>
                    </div>
