        ...
        <div
            ...
            <div className="flex-grow flex flex-wrap justify-center gap-6 p-6 w-full max-w-6xl mx-auto mt-8 items-start">
                {plans.map((plan, index) => (
                    <div
                        key={index}
                        className="w-full sm:w-80 rounded-xl p-6 border border-[#252525] hover:border-green-700 transition duration-300 flex flex-col"
                        style={{ minHeight: "550px", maxHeight: "550px", overflow: "hidden" }}>
                        <div className="pb-4">
                            <h3
                                className="text-lg font-semibold text-lefttext-white">
                                {plan.title}
                            </h3>
                        </div>
                        ...
                        <ul className="mb-6 space-y-2 text-sm text-white overflow-hidden">
                            {plan.features.map((feature, i) => (
                                <li key={i} className="flex items-center gap-2">
                                    <span className="text-green-700 font-bold">✔</span> {feature}
                                </li>
                            ))}
                        </ul>
